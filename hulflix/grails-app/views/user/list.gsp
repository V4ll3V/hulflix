			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="userPicture" title="${message(code: 'user.userPicture.label', default: 'User Picture')}" />
				...
				<g:each in="${userInstanceList}" status="i" var="userInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: userInstance, field: "userPicture")}</td>
