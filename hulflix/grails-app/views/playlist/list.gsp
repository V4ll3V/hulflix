...
<html>
	...
	<body>
		<a href="#list-playlist" class="skip" tabindex="-1"><g:message code="default.link.skip.label" default="Skip to content&hellip;"/></a>
			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="playlistName" title="${message(code: 'playlist.playlistName.label', default: 'Playlist Name')}" />
					
						<th><g:message code="playlist.user.label" default="User" /></th>
