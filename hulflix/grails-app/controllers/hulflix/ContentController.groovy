...
class ContentController {
	...
	def searchcontent ={params->
		List<Content> content = Content.findAll{
		}
    
	}
	def getcontentbyid ={params->
		Content content = Content.findById(params.id){}
		if(content.equals(null)){
			
			def error = ['error content not found']
			render error as JSON
		}else{
			def contents =[contents:content]
